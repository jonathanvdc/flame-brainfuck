...
Congratulations! You are now the (proud) author of a working Brainfuck compiler! Good job! For the complete source code, see [the `flame-brainfuck` GitHub page](https://github.com/jonathanvdc/flame-brainfuck/tree/master/src/brainfuck).
